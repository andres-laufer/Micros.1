...
# 12 "main.s" 2
 ...
 return
    ...
    Tm0_config:
 banksel TRISA
 bcf ((OPTION_REG) and 07Fh), 5 ;selección del reloj interno
 bcf ((OPTION_REG) and 07Fh), 3 ;asignamos prescaler al Timer0
 bcf ((OPTION_REG) and 07Fh), 2
 bcf ((OPTION_REG) and 07Fh), 1
 bcf ((OPTION_REG) and 07Fh), 0 ;prescaler a 2
 banksel PORTA
 ...
 return
    ...
    Tm2_config:
 bsf ((T2CON) and 07Fh), 2 ;encender el timer2
 bsf ((T2CON) and 07Fh), 6 ;postscaler a 16
 ...
 bsf ((OSCCON) and 07Fh), 4 ; reloj a 500KHz
 return

    config_interrup:
 banksel TRISA
 bsf ((INTCON) and 07Fh), 7
 bsf ((INTCON) and 07Fh), 5 ;interrupción del timer0
 bcf ((INTCON) and 07Fh), 2
 bsf ((INTCON) and 07Fh), 6 ;habilitar más interrupciones
 bsf ((PIE1) and 07Fh), 0 ;interrupción timer1
 bsf ((PIE1) and 07Fh), 1 ;interrupción timer2
 banksel PORTA
 bcf ((PIR1) and 07Fh), 0 ;limpieza de banderas
 bcf ((PIR1) and 07Fh), 1
 return
